            ...
            <div class="modal-content">
                ...
                <div class="modal-footer d-flex justify-content-between">
                    ...
                    <div class="">
                        ...
                        ?>
                            <button type="button" class="btn btn-danger modalId deleteBin" data-bin-id="">
                                <i class="fas fa-trash"></i>
                            </button>
                            <button type="button" class="btn btn-success modalId restoreBin" data-status-id="">
        ...
        <div class="right_panel bg-white">
            <main class="container-fluid alParent">
                ...
                <ol class="breadcrumb p-3 mb-4 rounded myLigthGrey">
                    <li class="breadcrumb-item active" aria-current="page">Recyle Bin</li>
                </ol>

                <!-- RecyleBin Tables -->
                <div class="card border-0 shadow mb-5">
                    <div class="card-header">
                        <i class="fas fa-table me-2"></i>Recyle Bin
                    </div>
                    <div class="card-body">

                        <div class="table-responsive">
                            <table id="recylebinTable" class="table table-striped table-hover" style="width: 100%;">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Name</th>
