    ...
    <div class="modal-dialog modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="modal-footer d-flex justify-content-between">
          ...
          <div class="">
            <button class="btn btn-success " data-bs-toggle="" data-bs-whatever="">
              <i class="fas fa-envelope"></i>
            </button>
            <button type="button" class="btn btn-warning modalId statusTrigger" data-status-id="">
      ...
      <main class="container-fluid alParent">
        ...
        <div class="card border-0 shadow mb-5">
          <div class="card-header">
            <i class="fas fa-table me-2"></i>All Feedback
          </div>
          <div class="card-body">

            <div class="table-responsive">
              <table id="manageTable" class="table table-striped table-hover" style="width: 100%;">
                <thead>
                  <tr>
                    <th>Id</th>
                    <th>Name</th>
